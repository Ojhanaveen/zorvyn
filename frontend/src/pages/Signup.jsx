        ...
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-[2rem] shadow-2xl shadow-indigo-100 overflow-hidden border border-slate-100">
          ...
          <div className="bg-indigo-600 p-12 text-white flex flex-col justify-between relative overflow-hidden hidden md:flex">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl font-display font-extrabold mb-8 leading-tight">
                Join the future of <br /> Finance Management.
              </h2>
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <p className="text-indigo-100 text-lg">Real-time transaction tracking & categorization.</p>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center shrink-0">
                    <CheckCircle2 size={16} className="text-white" />
                  </div>
                  <p className="text-indigo-100 text-lg">Secure RBAC with Admin, Analyst, and Viewer roles.</p>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center shrink-0">
                    <CheckCircle2 size={16} className="text-white" />
                  </div>
                  <p className="text-indigo-100 text-lg">Advanced analytics and data visualization.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="relative z-10 pt-12 flex items-center gap-4">
              ...
              <p className="text-indigo-200 text-sm font-medium italic">
                Trusted by 1,000+ teams worldwide for secure financial processing.
              </p>
            </div>
          </div>
          ...
          <div className="p-8 md:p-16 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <select
                    className="block w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition-all font-medium text-slate-900 appearance-none"
                    value={role}
            ...
            <p className="mt-8 text-center text-slate-500 font-medium">
              ...
              <Link to="/login" className="text-indigo-600 font-extrabold hover:underline">Log in</Link>
            </p>
          </div>
        </div>
      </div>
